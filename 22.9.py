array = [int(x) for x in input("Введите через пробел целые числа в любом порядке").split()]
...
while True:
    try:
        element = int(input("Введите из полученного списка любое положительное число"))
